...
cd <- child_data %>%
  ...
  select(language, género, subj, age, age_scaled, age_interval, task, prompt, spanish, response_num, response, response_order, correct, correct_switch, adjacency, dist) %>%
